...
label9=Label(window,text='Counselor Name',font=("Arial",10,"bold"))
entry7=Entry(window)
label1=Label(window,text='Description of the Animal',font=("Arial",15,"bold"))
label2=Label(window,text='Kind of Animal',font=("Arial",10,"bold"))
entry1=Entry(window)
label3=Label(window,text='Sex',font=("Arial",10,"bold"))
entry2=Entry(window)
label4=Label(window,text='Age',font=("Arial",10,"bold"))
entry3=Entry(window)
label5=Label(window,text='Fur color',font=("Arial",10,"bold"))
entry4=Entry(window)
label6=Label(window,text='Breed',font=("Arial",10,"bold"))
entry5=Entry(window)
label7=Label(window,text='Health acknowledgement',font=("Arial",10,"bold"))
entry6=Entry(window,width=20)
Label(window,text='Specifics of the Caretaker/Foster',font=("Arial",15,"bold")).grid(row=7,column=1)
label10=Label(window,text='Caretaker/Foster’s name',font=("Arial",10,"bold"))
entry8=Entry(window)
label11=Label(window,text='Contact no.',font=("Arial",10,"bold"))
entry9=Entry(window)
label12=Label(window,text='Whatsapp number',font=("Arial",10,"bold"))
entry10=Entry(window)
label13=Label(window,text='Email',font=("Arial",10,"bold"))
entry11=Entry(window)
label14=Label(window,text='Local Residence',font=("Arial",10,"bold"))
entry12=Entry(window)
label15=Label(window,text='Permanent residence',font=("Arial",10,"bold"))
entry13=Entry(window)
Label(window,text='Specifics of the Adopter',font=("Arial",15,"bold")).grid(sticky="W",row=13,column=1)
label16=Label(window,text='Adopter\'s name',font=("Arial",10,"bold"))
entry14=Entry(window)
label17=Label(window,text='Contact no',font=("Arial",10,"bold"))
entry15=Entry(window)
label18=Label(window,text='whatsapp number',font=("Arial",10,"bold"))
entry16=Entry(window)
label19=Label(window,text='Line of work',font=("Arial",10,"bold"))
entry17=Entry(window)
label20=Label(window,text='Email',font=("Arial",10,"bold"))
entry18=Entry(window)
label21=Label(window,text='Local Residence',font=("Arial",10,"bold"))
entry19=Entry(window)
label22=Label(window,text='Permanent Residence',font=("Arial",10,"bold"))
entry20=Entry(window)
Label(window,text='What are your plans for taking care of your',font=("Arial",10,"bold")).grid(sticky="e",row=20,column=0)
label23=Label(window,text='pet in case you go out for some days?',font=("Arial",10,"bold"))
